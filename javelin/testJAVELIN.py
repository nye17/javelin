...
def genDRWandKeplerLC(dj, lcfile2, lcfile3):
...
def getPSDcomparison(dj, lcfile2, lcfile3):
...
def main():
    lcfile1 = "dat/mock_realistic.dat"
    #genRealisticLC(lcfile1)
    lcfile2 = "dat/mock_dense_drw.dat"
    lcfile3 = "dat/mock_dense_kpl.dat"
    dj = 0.01
    #genDRWandKeplerLC(dj, lcfile2, lcfile3)
    #getPSDcomparison(dj, lcfile2, lcfile3)
