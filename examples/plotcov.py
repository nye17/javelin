#Last-modified: 16 Apr 2012 02:39:20 PM


import matplotlib.pyplot as plt
from matplotlib import cm, mpl, font_manager
import numpy as np
...
def covdemo(set_color=True):
    ...
    # colorbar
    cax1 = fig.add_axes((xstart+cxdiff, ystart+ygutter+height+cydiff, cwidth,
        cheight))
    cax2 = fig.add_axes((xstart+xgutter+width+cxdiff,
        ystart+ygutter+height+cydiff, cwidth, cheight))
